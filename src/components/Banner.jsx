    ...
    return (
        <div className='flex flex-col-reverse md:flex-row  gap-5 items-center bg-base-200 p-10 justify-center rounded-lg mt-20'>
            <div className='w-full md:w-2/5 space-y-4'>
                <h1 className="text-5xl font-bold font-playfair leading-tight">Books to freshen up <br /> your bookshelf</h1>
                ...
                <Link to="/listed-books" className="btn btn-xs sm:btn-sm md:btn-md bg-green-500 hover:bg-green-700 text-white">View The List</Link>
            </div>
